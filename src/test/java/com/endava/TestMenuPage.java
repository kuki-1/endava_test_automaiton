...
public class TestMenuPage {
	...
	public void testAboutUsVisibility() {
		homePage.open();
		Assert.assertEquals(homePage.driver.getCurrentUrl(), homePage.getEndavaURL(), "Incorrect URL!");
		Assert.assertEquals(homePage.driver.getTitle(), homePage.getEndavaTitle(), "Incorrect title!");
		...
		log.info("isAboutUsVisible() : VALIDATION SUCCESSFUL!");
	}
